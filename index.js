...
exports.handler = function(event,context) {
    ...
    if (request.type === "LaunchRequest") {
        ...
        // when the user wants to do something with the app
        let options = {};
        ...
        // step 2 of the appointment booking process
        ...
        // final step of the booking process
        ...
        ExpressionAttributeValues: {
         ...
         docClient.scan(params, function(err, data){
            if (err) {
                ...
                options.speechText = "I am here to help you manage your appointent. I support 4 features. Book, cancel, query and help. If you want to book an appointment, for example, you can say. I would like to make an appointment. I will then ask you to specify the time and date for your appointment and you simply need to give me the information I need to proceed. For more information, you can have a look at te conversation flow chart on our application website. It will give you a better idea as to what you can do with this application.";
                options.endSession = true;
                context.succeed(buildResponse(options));
        }
